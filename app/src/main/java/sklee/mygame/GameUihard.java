...
public class GameUihard extends ActionBarActivity {
    ...
    private int[] xbuff=new int[10];
    private int[] ybuff=new int[10];
...
//    private TextView tvStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_ui3);
    ...
    private Handler handler = new Handler(){        // deliver the signal to layout
        ...
        public void handleMessage(Message msg) {
            ...
            else if(counter>gameTime)
            {
                ...
                TIME_.setText("START");
                for(int i = 0; i < 10; i++)   //suppose you have 10 buttons
                {
...
//                button[i] = ((Button) findViewById(resID));
        ...
        switch (i+1){
            ...
            case 8:
                ...
                break;
            case 9:
                button[i].setBackgroundResource(R.drawable.a9);
                break;
            case 10:
                button[i].setBackgroundResource(R.drawable.a10);
                break;
    ...
    for (int i = 0; i < 10; i++)   //suppose you have four buttons
    {
        //String buttonID = "button" + (i + 1);
        //int resID = getResources().getIdentifier(buttonID, "id", getPackageName());
...
//                tvStatus.setText("找到" + String.valueOf(nowNumber+1));
                ...
                switch (nowNumber+1){
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        button[nowNumber].setBackgroundResource(R.drawable.a9);
                        break;
                    case 10:
                        button[nowNumber].setBackgroundResource(R.drawable.a10);
                        break;
                }
...
//                    tvStatus.setText("找到最後一個數字遊戲勝利");
                ...
                switch (nowNumber+1) {
                    case 1:
                        ...
                        button[8].setBackgroundResource(R.drawable.e9);
                        button[9].setBackgroundResource(R.drawable.e10);
                        break;
                    case 2:
                        button[1].setBackgroundResource(R.drawable.e2);
                        button[2].setBackgroundResource(R.drawable.e3);
