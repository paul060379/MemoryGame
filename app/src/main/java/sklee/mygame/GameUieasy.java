 ...
 */
public class GameUieasy extends ActionBarActivity {
    ...
    private int[] xbuff=new int[6];
    private int[] ybuff=new int[6];
    ...
    private Handler handler = new Handler(){        // deliver the signal to layout
        ...
        public void handleMessage(Message msg) {
            ...
            else if(counter>gameTime)
            {
                ...
                TIME_.setText("START");
                for(int i = 0; i < 6; i++)   //suppose you have 6 buttons
                {
...
//                button[i] = ((Button) findViewById(resID));
        ...
        for (int i = 0; i < 6; i++)   //suppose you have four buttons
        {
            //String buttonID = "button" + (i + 1);
            //int resID = getResources().getIdentifier(buttonID, "id", getPackageName());
